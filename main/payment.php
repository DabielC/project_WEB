            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                ...
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Mastercard">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
					...
					gap-2 h-28 w-full bg-white border-2 border-gray-200 rounded-md transition
                        ...
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Visa">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
                    <div class="payment-content border-3 hover:border-blue-500 items-center relative
              		...
              		peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Union pay">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
                    ...
                    gap-2 h-28 w-full bg-white border-2 border-gray-200 rounded-md transition
                  	peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Kasikorn Bank">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
                    <div class="payment-content border-3 hover:border-blue-500 items-center relative
                        ...
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Krunthai Pay">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
                    ...
                    gap-2 h-28 w-full bg-white border-2 border-gray-200 rounded-md transition
                  	peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=SCB Bank">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
                  ...
                  peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Krungsri Bank">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
                  ...
                  peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=BangKok Bank">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
                  ...
                  peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=TMB Bank">
        ...
        <section class="max-w-[900px] mx-auto px-8 pt-8 ">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <label for="payment" class="relative w-full cursor-pointer">
                  ...
                  peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Alipay">
            ...
            <label for="payment" class="relative w-full cursor-pointer">
                    ...
                    peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=WeChat Pay">
            ...
            <label for="payment" class="relative w-full cursor-pointer">
                    ...
                    peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Rabbit Line Pay">
                ...
                <label for="payment" class="relative w-full cursor-pointer">
                    ...
                    peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=True Money Wallet">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <label for="payment" class="relative w-full cursor-pointer">
                  ...
                  peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Prompy Pay">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <label for="payment" class="relative w-full cursor-pointer">
                  ...
                  peer-checked:border-blue-500 peer-checked:shadow-lg peer-checked:-translate-y-1 ">
                        <div class="h-24 w-full text-center ">
                            <div class="h-4/5 text-center">
                                <a href="http://localhost/project_web/project_WEB/main/payment.php?method=Counter Service 7-11">
